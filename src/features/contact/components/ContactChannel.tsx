...
export const ContactChannel: React.FC<ContactChannelProps> = ({
  ...
  return (
    <div className="group relative flex flex-col items-start justify-between gap-4 border border-white/[0.06] bg-[#050505] p-6 transition-colors duration-500 hover:border-lab-red/30 sm:flex-row sm:items-center sm:p-8">
      {/* Corner crosshairs */}
      ...
      <div>
        ...
        <p className="mt-2 font-mono text-lg tracking-widest text-white/90 sm:text-xl">
          {content}
        </p>
      </div>
      ...
      <button
        onClick={handleCopy}
        className={`shrink-0 border px-6 py-2.5 font-mono text-[11px] uppercase tracking-[0.15em] transition-colors ${
          copied 
