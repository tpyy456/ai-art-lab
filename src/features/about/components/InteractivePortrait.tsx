...
export default function InteractivePortrait() {
  ...
  return (
    <section
      ...
      className="relative min-h-[26rem] w-full overflow-hidden border border-white/[0.06] bg-[#080808] sm:min-h-[38rem] lg:h-full lg:min-h-[44rem]"
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-[#0d0d0f]">
        ...
        <div className="flex flex-col items-center gap-3 px-6 text-center">
          <span className="font-mono text-[10px] tracking-[0.18em] text-white/30 sm:tracking-[0.3em]">[ REAL HUMAN LAYER / 真实影像层 ]</span>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 px-6 text-center">
          <span className="font-mono text-[10px] tracking-[0.18em] text-lab-red/50 sm:tracking-[0.3em]">[ DIGITAL MASK LAYER / 数字外壳层 ]</span>
